...
export const projects: Project[] = [
  {
    ...
    endDate: new Date('10/27/2019'),
    reason: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, nobis, possimus? Dolor ipsam repudiandae veritatis?',
